            ...
            <div class="form-header">
                <div>
                    ...
                    <select name="device_type">
                        ...
                        <option value="CENTRAL_UNIT" <?php if (isset($_POST['device_type']) && $_POST['device_type'] == "CENTRAL_UNIT") echo 'selected'; ?>>
                            Unité centrale
                        </option>
                        <option value="SCREEN" <?php if (isset($_POST['device_type']) && $_POST['device_type'] == "SCREEN") echo 'selected'; ?>>
                            Écran
                        </option>
                    </select>
                </div>
